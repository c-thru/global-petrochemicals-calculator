...
-   PPA is generally mixed with other plastics, hence, it there is limited recycling, with most going to incineration and land filling [@hirschberg_recycling_2023].
...
-   Mechanical recycling degrades the polymer properties of thermosettting PURs [@rossingnolo_recycling_2024] and PPA [@hirschberg_recycling_2023], so chemical recycling is most appropriate.
